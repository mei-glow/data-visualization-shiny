...
LAYOUT_BASE = dict(
    ...
    font=dict(family="'Syne', 'Inter', sans-serif", color=WHITE),
...
.navbar .brand {
    font-family: 'Syne', sans-serif;
    font-size: clamp(1.15rem, 3vw, 2.3rem); font-weight: 800;
...
.section h1 {
    ...
    font-weight: 800; color: var(--white); margin: 0 0 16px;
    line-height: 1.1; letter-spacing: -1px;
}
.section h2 {
    font-family: 'Syne', sans-serif; font-size: clamp(2.3rem, 4vw, 4.2rem);
...
.kpi-card .kpi-value { font-family: 'Syne', sans-serif; font-size: 2.2rem; font-weight: 800; color: var(--white); margin: 0; }
...
.stat-block .stat-value { font-family: 'Syne', sans-serif; font-size: 2.4rem; font-weight: 800; color: var(--orange); }
...
.rank-item .rank-val { font-family: 'Syne', sans-serif; font-size: 1.3rem; font-weight: 700; color: var(--teal); }
...
.highlight-card .hl-value { font-family: 'Syne', sans-serif; font-size: 1.5rem; font-weight: 700; color: var(--white); }
...
app_ui = ui.page_fluid(
    ...
    ui.div(
        ui.div(
            ...
            <div class="chart-panel" style="max-width:620px;padding:0;overflow:hidden;margin:24px 0;">
              <img src="https://images.unsplash.com/photo-1617886903355-9354bb57751f?w=800&q=80"
                   style="width:100%;display:block;border-radius:12px;" alt="EV taxi night city"/>
              <div style="padding:10px 16px;font-size:0.75rem;color:var(--muted);">Bogotá, Colombia • 2023 EV Adoption Cohort</div>
            </div>
            """),
    ...
    ui.div(
        ui.div(
            ...
            <div style="text-align:center;margin:8px auto 40px;">
              <div style="font-family:Syne,Inter,sans-serif;font-size:clamp(96px,18vw,260px);line-height:.8;font-weight:800;color:#dbeafe;letter-spacing:-8px;">1.2</div>
              <div style="font-family:Syne,Inter,sans-serif;font-size:clamp(24px,4vw,44px);font-weight:800;color:var(--muted);margin-top:-8px;">Billion Tons</div>
            </div>
            """),
            ui.div(
    ...
    ui.div(
        ui.div(
            ...
            ui.div(
                ui.HTML("""
                <img src="https://images.unsplash.com/photo-1593941707882-a5bba53b5e94?w=700&q=80"
        ...
        ui.div(
            ...
            ui.div(
                ...
                ui.div(
                    ...
                    <div style="font-family:Syne,sans-serif;font-size:2rem;font-weight:800;">2.8%</div>
    ...
    ui.div(
        ui.div(
            ...
            ui.div(
                ui.input_slider("race_year", "Year", min=2010, max=2024, value=2024, step=1, width="400px"),
            ...
            ui.div(
                ...
                ui.div(
                    ...
                    <div style="margin-bottom:16px;">
                      ...
                      <div style="font-family:Syne,sans-serif;font-size:2.5rem;font-weight:800;color:var(--red);">78.2</div>
                    </div>
    ...
    ui.div(
        ui.div(
            ...
            ui.div(
                ui.HTML('<span style="color:var(--muted);">â„¹ "Most lower-middle income countries maintain a higher PHEV proportion as a stepping stone to full electrification."</span>'),
                class_="insight-box"
            ),
        ),
...
def server(input, output, session):
    ...
    def chart_race():
        ...
        fig.add_annotation(
            x=max_v * 0.6, y=countries[-1],
            text="China takes the lead — and never looks back." if "China" in countries[-3:] else "",
            showarrow=True, arrowhead=1, arrowcolor=TEAL, font=dict(size=11, color=WHITE),
            bgcolor=PANEL, bordercolor=TEAL, borderwidth=1
        )
        apply_theme(fig, height=380, xaxis_title="EV Stock (Millions)",
                    xaxis_range=[0, max_v * 1.25])
        fig.update_layout(
            title=dict(text=f"<b style='color:{TEAL};font-size:48px;'>{yr}</b>",
                       x=0.98, xanchor="right", y=0.98, yanchor="top",
                       font=dict(family="Syne", size=48, color=TEAL))
        )
        return fig
